...
def draw_face_landmarks(image, landmarks):
    ...
    # if len(landmark_point) > 0:
    #     # 참고 ：https://github.com/tensorflow/tfjs-models/blob/master/facemesh/mesh_map.jpg
...
def draw_pose_landmarks(
    ...
    for index, landmark in enumerate(landmarks.landmark):
        ...
        # if index == 17:  # 왼쪽 손목
        #     cv.circle(image, (landmark_x, landmark_y), 5, (0, 255, 0), 2)
        # if index == 18:  # 오른손 1 (외부 끝)
        #     cv.circle(image, (landmark_x, landmark_y), 5, (0, 255, 0), 2)
        # if index == 19:  # 오른손 2 (끝)
        #     cv.circle(image, (landmark_x, landmark_y), 5, (0, 255, 0), 2)
        # if index == 20:  # 왼손 2 (끝)
        #     cv.circle(image, (landmark_x, landmark_y), 5, (0, 255, 0), 2)
        # if index == 21:  # 오른손 3 (안쪽 끝)
        #     cv.circle(image, (landmark_x, landmark_y), 5, (0, 255, 0), 2)
        # if index == 22:  # 왼손 3 (안쪽 끝)
            # cv.circle(image, (landmark_x, landmark_y), 5, (0, 255, 0), 2)
        # if index == 23:  # 허리 (오른쪽)
        #     cv.circle(image, (landmark_x, landmark_y), 5, (0, 255, 0), 2)
        # if index == 24:  # 허리 (왼쪽)
